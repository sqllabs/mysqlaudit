...
func (s *testSuite) TestShow(c *C) {
	...
	row := result.Rows()[0]
	// For issue https://github.com/sqllabs/mysqlaudit/issues/1061
	...
	// For issue https://github.com/sqllabs/mysqlaudit/issues/1918
	...
	// for issue https://github.com/sqllabs/mysqlaudit/issues/4224
	...
	// for issue https://github.com/sqllabs/mysqlaudit/issues/3747
	...
	// for issue https://github.com/sqllabs/mysqlaudit/issues/4678
	...
	// for issue https://github.com/sqllabs/mysqlaudit/issues/4411
	...
	// for issue https://github.com/sqllabs/mysqlaudit/issues/4424
	...
	// for issue https://github.com/sqllabs/mysqlaudit/issues/4425
	tk.MustExec("drop table if exists show_test")
	testSQL = `create table show_test(
	...
	// for issue https://github.com/sqllabs/mysqlaudit/issues/4426
	tk.MustExec("drop table if exists show_test")
	testSQL = `create table show_test(
		a bit(1),
